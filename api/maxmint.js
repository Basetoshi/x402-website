// x402Cats API endpoint - Max mint (60 USDC for 20 NFTs)
// Place this file in: /api/maxmint.js
...
export default function handler(req, res) {
  ...
  // x402 schema for max mint (20 NFTs)
  const x402Schema = {
    "x402Version": 1,
    "accepts": [
      {
  ...
  return res.status(402).json(x402Schema);
}